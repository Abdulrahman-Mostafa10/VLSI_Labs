module generic_piplined_multiplier_detailed_routing (clk,
    rst,
    A,
    B,
    Result);
 ...
 sky130_fd_sc_hd__inv_2 _737_ (.A(net54),
    .Y(_079_));
 sky130_fd_sc_hd__dfrtp_1 _738_ (.CLK(clknet_3_2__leaf_clk),
    .D(\Product_reg2[0] ),
    .RESET_B(_016_),
    .Q(net18));
 sky130_fd_sc_hd__dfrtp_1 _739_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .RESET_B(_017_),
    .Q(net25));
 sky130_fd_sc_hd__dfrtp_1 _740_ (.CLK(clknet_3_2__leaf_clk),
    .D(\Product_reg2[2] ),
    .RESET_B(_018_),
    .Q(net26));
 sky130_fd_sc_hd__dfrtp_1 _741_ (.CLK(clknet_3_2__leaf_clk),
    .D(\Product_reg2[3] ),
    .RESET_B(_019_),
    .Q(net27));
 sky130_fd_sc_hd__dfrtp_1 _742_ (.CLK(clknet_3_2__leaf_clk),
    .D(\Product_reg2[4] ),
    .RESET_B(_020_),
    .Q(net28));
 sky130_fd_sc_hd__dfrtp_1 _743_ (.CLK(clknet_3_3__leaf_clk),
    .D(\Product_reg2[5] ),
    .RESET_B(_021_),
    .Q(net29));
 sky130_fd_sc_hd__dfrtp_1 _744_ (.CLK(clknet_3_3__leaf_clk),
    .D(\Product_reg2[6] ),
    .RESET_B(_022_),
    .Q(net30));
 sky130_fd_sc_hd__dfrtp_1 _745_ (.CLK(clknet_3_3__leaf_clk),
    .D(\Product_reg2[7] ),
    .RESET_B(_023_),
    .Q(net31));
 sky130_fd_sc_hd__dfrtp_1 _746_ (.CLK(clknet_3_3__leaf_clk),
    .D(\Product_reg2[8] ),
    .RESET_B(_024_),
    .Q(net32));
 sky130_fd_sc_hd__dfrtp_1 _747_ (.CLK(clknet_3_6__leaf_clk),
    .D(\Product_reg2[9] ),
    .RESET_B(_025_),
    .Q(net33));
 ...
 sky130_fd_sc_hd__dfrtp_1 _755_ (.CLK(clknet_3_0__leaf_clk),
    ...
    .RESET_B(_033_),
    .Q(\Product_reg0[1] ));
 sky130_fd_sc_hd__dfrtp_1 _756_ (.CLK(clknet_3_0__leaf_clk),
    .D(_002_),
    .RESET_B(_034_),
    .Q(\Product_reg0[2] ));
 sky130_fd_sc_hd__dfrtp_1 _757_ (.CLK(clknet_3_0__leaf_clk),
    .D(_003_),
    .RESET_B(_035_),
    .Q(\Product_reg0[3] ));
 sky130_fd_sc_hd__dfrtp_1 _758_ (.CLK(clknet_3_0__leaf_clk),
    .D(_004_),
    .RESET_B(_036_),
    .Q(\Product_reg0[4] ));
 sky130_fd_sc_hd__dfrtp_1 _759_ (.CLK(clknet_3_1__leaf_clk),
    .D(_005_),
    .RESET_B(_037_),
    .Q(\Product_reg0[5] ));
 sky130_fd_sc_hd__dfrtp_1 _760_ (.CLK(clknet_3_1__leaf_clk),
    .D(_012_),
    .RESET_B(_038_),
    .Q(\Product_reg0[6] ));
 sky130_fd_sc_hd__dfrtp_1 _761_ (.CLK(clknet_3_1__leaf_clk),
    .D(_013_),
    .RESET_B(_039_),
    .Q(\Product_reg0[7] ));
 sky130_fd_sc_hd__dfrtp_1 _762_ (.CLK(clknet_3_4__leaf_clk),
    .D(_014_),
    .RESET_B(_040_),
    .Q(\Product_reg0[8] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _764_ (.CLK(clknet_3_4__leaf_clk),
    ...
    .RESET_B(_042_),
    .Q(\Product_reg0[10] ));
 sky130_fd_sc_hd__dfrtp_1 _765_ (.CLK(clknet_3_4__leaf_clk),
    .D(_007_),
    .RESET_B(_043_),
    .Q(\Product_reg0[11] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _776_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .RESET_B(_054_),
    .Q(\Product_reg1[6] ));
 sky130_fd_sc_hd__dfrtp_1 _777_ (.CLK(clknet_3_1__leaf_clk),
    .D(\Product_reg0[7] ),
    .RESET_B(_055_),
    .Q(\Product_reg1[7] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _790_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .RESET_B(_068_),
    .Q(\Product_reg2[4] ));
 sky130_fd_sc_hd__dfrtp_1 _791_ (.CLK(clknet_3_3__leaf_clk),
    .D(\Product_reg1[5] ),
    .RESET_B(_069_),
    .Q(\Product_reg2[5] ));
 sky130_fd_sc_hd__dfrtp_1 _792_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .RESET_B(_070_),
    .Q(\Product_reg2[6] ));
 sky130_fd_sc_hd__dfrtp_1 _793_ (.CLK(clknet_3_3__leaf_clk),
    .D(\Product_reg1[7] ),
    .RESET_B(_071_),
    .Q(\Product_reg2[7] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _796_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .RESET_B(_074_),
    .Q(\Product_reg2[10] ));
 sky130_fd_sc_hd__dfrtp_1 _797_ (.CLK(clknet_3_7__leaf_clk),
    .D(\Product_reg1[11] ),
    .RESET_B(_075_),
    .Q(\Product_reg2[11] ));
