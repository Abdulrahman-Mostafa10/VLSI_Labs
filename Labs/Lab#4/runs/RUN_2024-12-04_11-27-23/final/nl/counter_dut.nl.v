module counter_dut (clk,
 ...
 sky130_fd_sc_hd__a21oi_1 _27_ (.A1(net4),
    ...
    .B1(_06_),
    .Y(_08_));
 sky130_fd_sc_hd__o21ai_1 _28_ (.A1(net9),
    .A2(_05_),
    .B1(_08_),
    .Y(_00_));
 ...
 sky130_fd_sc_hd__xnor2_1 _38_ (.A(_10_),
    .B(_16_),
    .Y(_17_));
 sky130_fd_sc_hd__a21oi_1 _39_ (.A1(net8),
    .A2(_07_),
    .B1(_06_),
    .Y(_18_));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold2 (.A(net4),
    .X(net9));
 sky130_fd_sc_hd__dlygate4sd3_1 hold3 (.A(net7),
    .X(net10));
 sky130_fd_sc_hd__dlygate4sd3_1 hold4 (.A(_03_),
    .X(net11));
 ...
 sky130_fd_sc_hd__decap_6 FILLER_7_10 ();
