module counter_dut (clock,
 ...
 sky130_fd_sc_hd__a31o_2 _45_ (.A1(_04_),
    ...
    .B1(_06_),
    .X(_03_));
 sky130_fd_sc_hd__dfxtp_2 _46_ (.CLK(clock),
    .D(_00_),
    .Q(counter[0]));
 sky130_fd_sc_hd__dfxtp_2 _47_ (.CLK(clock),
    .D(_01_),
    .Q(counter[1]));
 sky130_fd_sc_hd__dfxtp_2 _48_ (.CLK(clock),
    .D(_02_),
    .Q(counter[2]));
 sky130_fd_sc_hd__dfxtp_2 _49_ (.CLK(clock),
    .D(_03_),
    .Q(counter[3]));
endmodule
